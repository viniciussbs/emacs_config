...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(region ((,class (:background ,color-light))))
   `(highlight ((,class (:foreground ,fg3 :background ,bg3))))
   `(hl-line ((,class (:background  ,color-white))))
   `(fringe ((,class (:background ,color-lighter))))
   `(cursor ((,class (:background ,color-base))))
   `(show-paren-match-face ((,class (:background ,warning))))
   `(isearch ((,class (:bold t :foreground ,color-black :background ,color-light))))
   `(mode-line ((,class (:box nil :underline nil :overline nil :background ,color-dark :foreground ,color-black))))
   `(powerline-active1 ((,class (:background ,color-base :foreground ,foreground))))
   `(powerline-active2 ((,class (:background ,color-light :foreground ,foreground))))
   ...
   `(web-mode-comment-face ((,class (:foreground ,foreground))))
