...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (nord-theme flycheck-credo smartparens avy feature-mode evil yaml-mode web-mode slim-mode scss-mode restclient projectile powerline markdown-mode magit lua-mode lorem-ipsum js2-refactor inf-ruby flycheck flx-ido expand-region emmet-mode alchemist))))
(custom-set-faces
