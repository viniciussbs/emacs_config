...
(load-file "~/.config/emacs/config/packages.el")
(load-file "~/.config/emacs/config/common.el")
(load-file "~/.config/emacs/config/ui.el")
(load-file "~/.config/emacs/config/editor.el")
(load-file (concat "~/.config/emacs/config/os/" (cond ((eq system-type 'darwin) "osx.el")
